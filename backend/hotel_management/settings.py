...
DATABASES = {
    'default': {
        ...
        'NAME': config('RDS_DB_NAME', default='hotel_management_system'),
        'USER': config('RDS_USERNAME', default='postgres'),
        'PASSWORD': config('RDS_PASSWORD', default='123'),
        'HOST': config('RDS_HOST', default='localhost'), 
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@hotelmanagement.com')
